...
class Notices(models.Model):
    ...
    tweetLikes = models.ManyToManyField(TweetRelations, blank=True, related_name="notices_tweet_like",verbose_name="tweet点赞")
    tweetCollects = models.ManyToManyField(TweetRelations, blank=True, related_name="notices_tweet_collect",verbose_name="tweet收藏")
